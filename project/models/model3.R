...
mcmc_areas(posterior %>% select(y_pred), 
  ...
  xlab("Duration [days]")
if (save) ggsave("../626fca86090ba51a6aff419a/plots/model3_postpred.pdf", width = 7, height = 5)
...
mcmc_areas(posterior %>% select(sigma1, sigma2), 
  ...
  xlab("Duration [days]")
if (save) ggsave("../626fca86090ba51a6aff419a/plots/model3_postsigma.pdf", width = 7, height = 5)
...
mcmc_areas(posterior %>% select(p), 
  ...
  theme_gray() + ylab("Posterior Distribution") +
  xlab("Probability")
if (save) ggsave("../626fca86090ba51a6aff419a/plots/model3_postp.pdf", width = 7, height = 5)
...
if (save) ggsave("../626fca86090ba51a6aff419a/plots/checkingModel3.pdf", width = 7, height = 5)
